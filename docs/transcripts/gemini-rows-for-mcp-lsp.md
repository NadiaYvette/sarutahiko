...
> never as canon (DOC_STRATEGY §1 canonicity table, §5). The inherited title reflected
> only the first question of a wandering conversation; the filename records the actual
> topic (extensible records for MCP/LSP). Freely renamable.
